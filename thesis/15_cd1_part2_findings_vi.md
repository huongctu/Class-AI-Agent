...
> **Phiên bản 3.1a (06/05/2026 — QW1)**: Tách Bảng 4.1 phân nhóm Advanced thành 2 dòng (innovation 1,03 vs resource 0,49 — tỷ số 2,1×).
> **Phiên bản 3.1c (06/05/2026 — QW5)**: Bổ sung Kiribati 2025 (n=150) vào nhóm SIDS — pool 101.035 → 101.185 doanh nghiệp; 107 → 108 country-years; 12 → 14 đợt khảo sát 2025 (thêm Kiribati và Tonga 2024). Số liệu Kiribati từ WBES Country Profile 2025: FSTS 1,03%; FDI ≥10% chỉ 0,7%; website 18,7% (LOW — khác hẳn Fiji 74,8%); ISO 1,3%; sd log năng suất 1,48 — **Kiribati là trường hợp biên CỰC ĐOAN nhất của SIDS Thái Bình Dương**, bằng chứng mạnh cho forced internationalization penalty.
...
*Ghi chú: (1) Phân nhóm Advanced được tách thành hai phân nhóm con (innovation-driven so với resource-driven) ở v3.1 theo phát hiện (ii) §4.7. **Tỷ số phân tán Singapore (1,03) so với Vùng Vịnh (0,49) ≈ 2,1 lần**. (2) SIDS row cập nhật v3.1 với Kiribati 2025 (n=150, sd log năng suất 1,48 — cao hơn trung bình SIDS 1,29) làm tăng tổng SIDS lên 947 + 150 = 1.097 doanh nghiệp ở 10 cặp QG×năm; sd log gộp ước tính tăng nhẹ từ 1,29 lên ~1,32. P90/P10 và P75/P25 chi tiết sẽ được cập nhật ở Giai đoạn 1 (tháng 6/2026 — sau khi pool có biến quy đổi USD PPP).*
...
**(viii) Đợt khảo sát 2025 là *mẫu đơn năm lớn nhất* và *đa dạng nhất* trong nhóm dữ liệu** *(NEW D2, §4.10 — cập nhật v3.1 với Kiribati)*. **14 nước × 16.979 doanh nghiệp** (16,8% tổng nhóm dữ liệu) đại diện đầy đủ 5 phân nhóm con ICRV trong cùng đợt. Bốn phát hiện chính:
...
- (b) **Fiji — nhảy vọt số** với website 74,8% > Singapore 66,1%; **Kiribati — đối lập với Fiji** với website chỉ 18,7%, FSTS 1,03% — chứng minh dị biệt SIDS rõ rệt;
...
(c) **Hai đặc tả mô hình kiểm định vững** cho CĐ2: Đặc tả 1 — phạm vi đầy đủ 2009–2025 (n=101.185, DAI/TCI đơn thành phần); Đặc tả 2 — độ chính xác cao 2018–2025 (n≈50.000, DAI/TCI đa thành phần 5 chiều). Bằng chứng hai biến ở Chương 4 chỉ ra: phát hiện chính ở Đặc tả 1 phải tái lập được ở Đặc tả 2 (theo tiêu chí của Aguinis et al., 2011) — đặc biệt: (i) tỷ số phân tán phân nhóm con Advanced 2,1 lần; (ii) Mongolia DAI tăng nhưng FSTS không tăng; (iii) SIDS nhảy vọt số nhưng FSTS thấp.
...
> **Mới ở v2.8 (D2)**: Đợt 2025 chiếm 16.979 doanh nghiệp (16,8% nhóm dữ liệu — cập nhật v3.1 với Kiribati 2025) — đợt khảo sát đơn năm lớn nhất. Phát hiện chính: tác động khung dữ liệu (schema effects), nhảy vọt số ở SIDS Thái Bình Dương (đặc biệt Fiji), và dữ liệu cho phân nhóm con Advanced. **v3.1: bổ sung Kiribati 2025 — đối lập với Fiji về digital adoption**.
...
*Ghi chú: ¹Nepal 2025 — khung dữ liệu BREADY chưa thống nhất, sẽ xử lý lại ở Giai đoạn 1. ²Kiribati 2025: số liệu chính thức từ WBES Country Profile 2025 (World Bank Enterprise Surveys, 2025) cộng phân tích `Kiribati-2025-full-data.dta` (336 cột, 150 doanh nghiệp, June–December 2025); Lower Middle Income Group; sectors covered: Manufacturing, Construction, Wholesale, Retail, Hotels, Transport, IT, Professional services. Kiribati phụ thuộc viện trợ Australia/New Zealand chiếm ~30% GDP.*

**Bảy phát hiện** (cập nhật v3.1 — thêm phát hiện 7 về Kiribati): (1) Ấn Độ — FSTS sụt 5 đpt do tác động khung dữ liệu (schema effect); (2) Thái Lan — "số tăng, xuất khẩu giảm" (digital up, exports down); (3) Fiji — website 74,8% vượt Singapore, minh chứng nhảy vọt số (digital leapfrog); (4) Vùng Vịnh và Brunei — xác nhận thuộc nhóm Advanced tài nguyên dẫn dắt (sd log 0,31–0,47); (5) R&D bị đánh giá vượt ngưỡng do thay đổi khung dữ liệu (schema-induced overestimation); (6) Năm 2025 — đợt khảo sát đơn năm đa dạng nhất, có thể dùng làm mẫu xác thực (validation sample) cho CĐ2; **(7) Kiribati 2025 — trường hợp biên CỰC ĐOAN nhất của SIDS Thái Bình Dương: FSTS 1,03% (gần zero), FDI 0,7% (gần zero), website 18,7% (LOW — đối lập với Fiji 74,8%), ISO 1,3% (gần zero), sd log năng suất 1,48 (cao nhất pool sau Frontier 1,36). Bằng chứng dị biệt SIDS rõ rệt: Fiji-Maldives = "high digital leapfrog" so với Kiribati = "isolated rural" — CĐ2 cần tách 2 phân nhóm con SIDS.**

**Sáu hàm ý cho CĐ2** (mở rộng từ 5 hàm ý cũ với Kiribati): (a) đợt 2025 làm mẫu xác thực (validation test bed); (b) hiệu ứng cố định khung dữ liệu hậu BREADY 2024 (Schema FE PostBREADY2024); (c) khả thi kiểm định phân nhóm con Advanced trên 11 quốc gia; (d) bằng chứng nhảy vọt số ở SIDS phục vụ H6; (e) dữ liệu mảng hai sóng (two-wave panel) cho 6 nước Emerging/Frontier; **(f) tách phân nhóm con SIDS cho CĐ2 — "high-digital SIDS" (FJI, MDV) so với "isolated SIDS" (KIR, có thể TON, VUT) — mở rộng 8 phân nhóm con thành 9 phân nhóm con với SIDS sub-grouping**.
...
*Phiên bản 3.1a (06/05/2026 — Quick Win 1) — Tách Bảng 4.1 phân nhóm Advanced (innovation 1,03 vs resource 0,49 — tỷ số 2,1×).*

*Phiên bản 3.1c (06/05/2026 — Quick Win 5) — Bổ sung Kiribati 2025 (n=150) vào nhóm SIDS: pool 101.035 → 101.185 doanh nghiệp; 107 → 108 country-years; 12 → 14 đợt 2025. Phát hiện mới (7) trong §4.10: Kiribati = SIDS extreme nhất với FSTS 1,03%, FDI 0,7%, website 18,7% — đối lập với Fiji digital leapfrog. Mở rộng (f) hàm ý CĐ2: tách phân nhóm con SIDS thành "high-digital SIDS" (FJI, MDV) so với "isolated SIDS" (KIR).*
