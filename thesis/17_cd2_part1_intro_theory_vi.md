...
**Mục tiêu chung**: Xây dựng mô hình nghiên cứu lý thuyết và thực nghiệm về ảnh hưởng của quốc tế hóa đến hiệu quả hoạt động kinh doanh của các doanh nghiệp ở các quốc gia châu Á, có khả năng kiểm định bằng dữ liệu WBES 101.035 doanh nghiệp xuyên 47 nền kinh tế giai đoạn 2009–2025.
...
1. **Giao thức hòa hợp ba thế hệ schema WBES** trên 105 file → pool 101.035 doanh nghiệp ở 47 nước × 107 cặp năm (xem `thesis/08_p7_data_harmonization_protocol_vi.md`). Đây là pool có phạm vi rộng nhất từng có cho nghiên cứu I→P trong văn liệu.
